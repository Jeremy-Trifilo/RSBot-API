...
public class Game 
{
        public static final int CLIENT_LOADING_ONE = 219911534;
        public static final int CLIENT_LOADING_TWO = 1099557670;
        
        public static final int LOGIN_SCREEN = 659734602;
        public static final int LOBBY_SCREEN = -498147143;

        public static final int LOGIN_CHECK_ONE = -1817616347;
        public static final int LOGIN_CHECK_TWO = -937970211;

        public static final int MAP_REGION_LOADING = 1759292272;
        public static final int LOGGED_IN = -2037527881;
	...
	{
		return Context.client().getLoginIndex() == LOGGED_IN;
	}

	/**
	 * @return The current world the local player is in. -1 means unable to retrieve world.
 	 * @param recheck <tt>true</tt> will force it to recheck the current world.
	 *	   <tt>false</tt> returns the current world or rechecks if world is -1.
	 */
